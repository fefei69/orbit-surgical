...
gym.register(
    ...
    kwargs={
        ...
        "robomimic_bc_vae_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc.json"),
        "robomimic_bc_transformer_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc.json"),
    },
    disable_env_checker=True,
)
